...
def generateUnseenPathsDF(unseenPath,mazes):
  fullSpikePaths = [ os.path.join(unseenPath, 'SpikePaths'+m) for m in mazes ]
  fullStepPaths =  [ os.path.join(unseenPath, 'StepPaths'+m) for m in mazes ]
  fullLoopPaths =  [ os.path.join(unseenPath, 'LoopPaths'+m) for m in mazes ]
  fullPathPaths = fullSpikePaths+fullStepPaths+fullLoopPaths
  pathsDF = dataFrame('unseenPathFile',fullPathPaths)
