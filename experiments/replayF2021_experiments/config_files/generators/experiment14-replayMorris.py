...
outputFileNoRats = '../norats14.csv'
outputFile     = '../experiment14-replayMorris.csv'     # relative to this folder
...
replay_budget_DF = dataFrame('replay_budget', [1000000])
...
dir_mazes_replay = 'experiments/mazes/OneShot/'
...
mazes_basic_DF = generateMazeDF(dir_mazes_replay, [ f'M00{m}.xml' for m in mazes])
