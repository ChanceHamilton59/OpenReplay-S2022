...
outputFileNoRats = '../norats13.csv'
outputFile     = '../experiment13-unseenPaths.csv'     # relative to this folder
...
mazes_basic_DF = generateMazeDF(dir_mazes_replay, [ f'M{m}.xml' for m in [0]])
...
ratsPerConfig = 1
no_rats_replay_m01_02 = reduce(allXall , [experiment_DF, group_DF, mazes_basic_DF, unseen_path_DF, layers_uniform_DF, traces_DF, replay_budget_DF, replay_memory_DF, propagation_type_DF] )
