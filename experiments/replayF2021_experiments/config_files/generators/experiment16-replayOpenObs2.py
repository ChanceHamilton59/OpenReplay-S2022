...
outputFileNoRats = '../norats16.csv'
outputFile     = '../experiment16-replayOpenObs2.csv'     # relative to this folder
...
mazeWidth   = 2.2
mazeHeight  = 3
episodesPerStartingLocation = 2
group          = 'g1'

experiment_DF = dataFrame('experiment', experiment)
group_DF      = dataFrame('group',      group)
traces_DF     = dataFrame('traces',     [ 0 ])
replay_budget_DF = dataFrame('replay_budget', [0,4000000,8000000])
replay_memory_DF = dataFrame('replay_memory', [1,4])
...
dir_mazes_replay = 'experiments/mazes/experiment16/'
dir_unseen_paths = 'experiments/unseen_paths/'

dir_layers  = 'experiments/pc_layers/'
dir_layers_uniform = dir_layers +'experiment16/'
