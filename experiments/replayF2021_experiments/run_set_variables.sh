...
declare -A E13=( ["NAME"]=experiment13-unseenPaths  ["BATCH_SIZE"]=100 ["SAMPLE_RATE"]=1  )
#E12[MIN_RAT]=39
#E12[MAX_RAT]=39

declare -A E14=( ["NAME"]=experiment14-replayMorris  ["BATCH_SIZE"]=100 ["SAMPLE_RATE"]=1  )
#E12[MIN_RAT]=39
#E12[MAX_RAT]=39

declare -A E15=( ["NAME"]=experiment15-replayOpenObs  ["BATCH_SIZE"]=100 ["SAMPLE_RATE"]=1  )
#E12[MIN_RAT]=39
#E12[MAX_RAT]=39
declare -A E16=( ["NAME"]=experiment16-replayOpenObs2  ["BATCH_SIZE"]=100 ["SAMPLE_RATE"]=1  )
