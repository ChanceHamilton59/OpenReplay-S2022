...
public class LogFirstPaths extends CycleTask {
    ...
    public void newTrial() {
        ...
        first_episode_to_log = positions +2;
        ...
        saveFile = BinaryFile.openFileToWrite(prefix + "first_paths.bin");
